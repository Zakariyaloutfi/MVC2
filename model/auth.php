...
// Classe représentant l'authentification des utilisateurs
    class Auth{
        private $table="tbl_token_auth"; // Table d'authentification
        private $Connexion;
...
// Déclaration des propriétés
        ...
        // Setters (mutateurs) pour chaque propriété
     ...
     // Récupère tous les tokens d'authentification
        ...
        // Récupère un token d'authentification par son ID
        ...
        // Insère un nouveau token dans la base de données
        public function insertToken($username, $random_password_hash, $random_selector_hash, $expiry_date){
            ...
            "); 
            // Correction $this->Film_nom --> $this->Film_nom
            $result = $query->execute(array(
                "username" => $username,
